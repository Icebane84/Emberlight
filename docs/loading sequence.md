...
4. Run   node testing/run_all_tests.js      → full 3-suite (344 checks) audit gate
```
...
Complex subsystems utilize a **Facade / Subsystem Partition Pattern** (`manifest/`, `dynamic_lights/`, `pseudo_3d/`, `battler_baker/`, `map/`, `combat/`, `auditor/`, `dungeon_gen/`, `runtime/`): sub-modules populate temporary staging membranes (`window._<Name>Internal`), and the root facade seals the canonical global before purging the membrane.
...
| **8 — Ephemeral Districts**              | `progression.js`, `combat/combat_*.js` (8 files) $\to$ `combat.js` (facade), `script.js`, `overworld.js`, `armory.js`, `market.js`, `chronicle.js`, `status.js`                                                                                                                                                                                                                                                                                                                                                                     |  15   | Tier 2     | `combat/`                                                  |
| **9 — Sentinel Audit Battery**           | `auditor/auditor_*.js` (7 pass suites) $\to$ `auditor.js` (facade)                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |   8   | Tier 4     | `auditor/`                                                 |
| **10 — Districts (cont.) & Persistence** | `relic_forge.js`, `dungeon_gen/dungeon_*.js` (3 files) $\to$ `dungeon_gen.js` (facade), `lockpick.js`, `settings.js`, `save_manager.js`                                                                                                                                                                                                                                                                                                                                                                                              |   7   | Tier 2 / 1 | `dungeon_gen/`, Root                                       |
| **11 — Orchestration & Runtime Engine**  | `runtime/runtime_*.js` (6 sub-modules) $\to$ `runtime.js` (facade)                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |   7   | Tier 1     | `runtime/`                                                 |
