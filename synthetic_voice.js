...
const EmberlightVoice = (() => {
  ...
  function synthesizeBark(char, speakerKey) {
    ...
    // Fundamental frequency with subtle per-character variance
    const jitter = 1.0 + (Math.random() * 2 - 1) * profile.pitchJitter;
